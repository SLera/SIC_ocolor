...
m1 = Basemap(resolution="i",
            projection='leae', lat_ts=70, lat_0=90., lon_0=-45., boundinglat = 50,
...
lon1,lat1 = m1(xx[0,-1],yy_reg[0,-1], inverse = True)
lon2,lat2 = m1(xx_reg[-1,0],yy_reg[-1,0], inverse = True)
...
m = Basemap(resolution="i",
            projection='lae', lat_ts=70, lat_0=90., lon_0=-45.,
